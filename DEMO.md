...
results, and is scoped wrong. <!-- METRIC:windows_product_count -->127<!-- /METRIC:windows_product_count --> of the <!-- METRIC:sigma_rule_count -->278<!-- /METRIC:sigma_rule_count --> corpus rules
...
<!-- METRIC:sigma_rule_count -->278<!-- /METRIC:sigma_rule_count --> rules while `splunk` and `opensearch-ppl` convert all
<!-- METRIC:sigma_rule_count -->278<!-- /METRIC:sigma_rule_count -->. All four Lucene targets fail on exactly the same
