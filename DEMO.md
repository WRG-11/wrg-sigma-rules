...
results, and is scoped wrong. <!-- METRIC:windows_product_count -->143<!-- /METRIC:windows_product_count --> of the <!-- METRIC:sigma_rule_count -->296<!-- /METRIC:sigma_rule_count --> corpus rules
...
share it: measured across the corpus, they convert <!-- METRIC:lucene_convert_count -->244<!-- /METRIC:lucene_convert_count --> of
<!-- METRIC:sigma_rule_count -->296<!-- /METRIC:sigma_rule_count --> rules while `splunk` and `opensearch-ppl` convert all
<!-- METRIC:sigma_rule_count -->296<!-- /METRIC:sigma_rule_count -->. All four Lucene targets fail on exactly the same
...
- Distinct ATT&CK techniques covered: 91
- Tactic groupings: 14
```
