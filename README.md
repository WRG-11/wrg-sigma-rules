...
### Sigma rule corpus (<!-- METRIC:sigma_rule_count -->296<!-- /METRIC:sigma_rule_count --> rules across <!-- METRIC:tactic_category_count -->14<!-- /METRIC:tactic_category_count --> ATT&CK tactic categories)
...
|---|---|---|
| `test` | <!-- METRIC:status_test_count -->82<!-- /METRIC:status_test_count --> | Derived from a real, cited incident — the `observed_*` campaign rules |
...
- **<!-- METRIC:test_module_count -->22<!-- /METRIC:test_module_count --> Python test modules** covering rule validation + tool integration smoke
